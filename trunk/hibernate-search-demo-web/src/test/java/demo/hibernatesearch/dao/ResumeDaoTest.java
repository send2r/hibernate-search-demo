...
public class ResumeDaoTest {
	...
	@Test
	@Rollback(false)
	public void testSeFindLimitEntity() throws Exception{
		long t1 = System.currentTimeMillis();
		Object resumes = resumeDao.getEntityLimit(new Class[]{User.class});
		for(Object ob : (List)resumes){
	...
	public void testFetchStrategy() throws Exception{
		long t1 = System.currentTimeMillis();
		Object resumes = resumeDao.seFetchStrategy();
		for(Object ob : (List)resumes){
			log.info(ob.getClass());
		}
		long t2 = System.currentTimeMillis();
